...
public class DIR_ESTABLECIMIENTOMODIFICADOENT
...
#REGION "ATRIBUTOS DE LA CLASE"
   ...
   Private _NOMBRE_INFORMANTE as String
   Private _CARGO_INFORMANTE as String
   Private _CODA_FONO_INFORMANTE as String
   Private _FONO_INFORMANTE as String
   Private _CELULAR_INFORMANTE as String
   Private _EMAIL_INFORMANTE as String
   Private _NOMBRE_JEFE_RESPONSABLE as String
...
#REGION "METODOS DE LA CLASE"
   ...
   Public Property CARGO_INFORMANTE() As String
       Get
           return _CARGO_INFORMANTE
       End Get
       Set(ByVal value As String)
           _CARGO_INFORMANTE = value
       End Set
   End Property


   Public Property CODA_FONO_INFORMANTE() As String
       Get
           return _CODA_FONO_INFORMANTE
       End Get
       Set(ByVal value As String)
           _CODA_FONO_INFORMANTE = value
       End Set
   End Property


   Public Property FONO_INFORMANTE() As String
       Get
           return _FONO_INFORMANTE
       End Get
       Set(ByVal value As String)
           _FONO_INFORMANTE = value
       End Set
   End Property


   Public Property CELULAR_INFORMANTE() As String
       Get
           return _CELULAR_INFORMANTE
       End Get
       Set(ByVal value As String)
           _CELULAR_INFORMANTE = value
       End Set
   End Property


   Public Property EMAIL_INFORMANTE() As String
       Get
           return _EMAIL_INFORMANTE
       End Get
       Set(ByVal value As String)
           _EMAIL_INFORMANTE = value
       End Set
   End Property


   Public Property NOMBRE_JEFE_RESPONSABLE() As String
       Get
           return _NOMBRE_JEFE_RESPONSABLE
       End Get
       Set(ByVal value As String)
           _NOMBRE_JEFE_RESPONSABLE = value
       End Set
   End Property
