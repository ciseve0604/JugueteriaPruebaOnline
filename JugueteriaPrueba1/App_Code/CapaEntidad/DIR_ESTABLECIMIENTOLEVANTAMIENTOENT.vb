...
public class DIR_ESTABLECIMIENTOLEVANTAMIENTOENT
...
#REGION "ATRIBUTOS DE LA CLASE"
   ...
   Private _TOTAL_PERSONAL_OCUPADO_MUJER as Integer
    ...
    Private _ROLBUSCA As String
    Private _DVROLBUSCA As String
    Private _RUTbusca As String
    Private _ROLSELECCION As String
...
#REGION "METODOS DE LA CLASE"
   ...
   Public Property TOTAL_PERSONAL_OCUPADO() As Integer
    ...
    Public Property DVROLBUSCA() As String
        Get
            Return _DVROLBUSCA
        End Get
        Set(ByVal value As String)
    ...
    Public Property ROLBUSCA() As String
        Get
            Return _ROLBUSCA
        End Get
        Set(ByVal value As String)
    ...
    Public Property ROLSELECCION() As String
        Get
            Return _ROLSELECCION
        End Get
        Set(ByVal value As String)
            _ROLSELECCION = value
        End Set
